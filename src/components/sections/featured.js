...
const Featured = () => {
  ...
  const featuredProjects = [
    {
      frontmatter: {
        title: 'Seamless Data Migration to Redshift Data Lake from Multiple Sources',
        tech: ['AWS'],
        github: null,
        external: null,
        cta: null,
    ...
    {
      frontmatter: {
        title: 'AWS QuickSight Object Migration.',
        tech: ['AWS'],
        github: null,
        external: null,
        cta: null,
      },
      html: '<p>Developed a highly efficient automated solution from the ground up, utilizing Python and the AWS APIs with the boto3 module to automate the migration of QuickSight Objects between same and cross-accounts.</p>',
    },
    {
      frontmatter: {
        title: 'Meta-data Comparison Project.',
        tech: ['AWS'],
        github: null,
        external: null,
        cta: null,
